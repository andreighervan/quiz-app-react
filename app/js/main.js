	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                null,
	                scorebox,
	                _react2['default'].createElement(_quizQuestionListJsx2['default'], _extends({ setCurrent: this.setCurrent.bind(this), setScore: this.setScore.bind(this) }, this.state)),
	                results
	            );
	        }
	    }]);
	                ...
	                _react2['default'].createElement(
	                    ...
	                    this.props.question.choices.map(function (choice) {
	                        return _react2['default'].createElement(
	                            ...
	                            choice.id,
	                            ' ',
	                            _react2['default'].createElement('input', { type: 'radio', onChange: _this.onChange.bind(_this), name: question.id,
	                                value: choice.id }),
	                            choice.text
	                        );
	                    })
